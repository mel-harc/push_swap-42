...
#    Updated: 2023/03/11 17:52:08 by mel-harc         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC = ft_error.c push_swap.c ft_check.c libft/ft_split.c libft/ft_strchr.c libft/ft_strlen.c \
		...
		libft/ft_update_index.c ft_swap_b.c ft_rank.c ft_bogo_sort.c
